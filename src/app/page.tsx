    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-between bg-gray-200">
            <div className="site-container flex flex-col gap-8 w-full px-4 py-8 mx-auto">
                ...
                <img src="/dark-mountains.png" className="absolute object-cover w-full h-full right-[-35%]"/>
                        ...
                        <div className="copy-container flex flex-col gap-4">
                            <div className="flex flex-col z-10">
                                ...
                                <h1 className="text-xl md:text-4xl font-semibold text-white">
                                    “They (those in Berea) received the word
                                    with all eagerness, examining the Scriptures
                                    daily…”
                                </h1>
                            </div>
                            <p className="text-white text-sm md:text-base z-10">
                                Our mission is to pursue and proclaim Jesus
                                together. <br />
                                Together, we accomplish this mission as we
                                collectively fix our gaze on Jesus when we
                                gather, being transformed to be more like Jesus
                                as we grow, and put Him on display to all around
                                us as we go.
                                <br />
                                The process seen in Scripture is a continuous
                                cycle where we gather, grow, go, living out the
                                Gospel in our community, region, and around the
                                world.
                            </p>
                    ...
                    <div className="col-span-8 flex flex-col gap-8">
                        <div>
                            <div className="aspect-video rounded-lg flex flex-col relative hover:scale-105 duration-300 shadow-sm hover:shadow-lg">
                                ...
                                />
                                {/* <div className="absolute inset-0 bg-gradient-to-t from-gray-800 opacity-50 rounded-lg"></div> */}
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="flex flex-col md:grid grid-cols-12 gap-4">
                                ...
                                <a
                                    ...
                                    <img src="/dark-mountains.png" className="absolute object-cover w-full h-full"/>
                                </a>
                                <a
                                    href="#"
                                    className="relative overflow-hidden flex flex-col items-center justify-center gap-2 col-span-6 aspect-video rounded-lg p-4 hover:scale-105 duration-300 shadow-sm hover:shadow-lg">
                                        ...
                                        <img src="https://thebelonging.co/wp-content/uploads/2021/04/PAST-MESSAGES_DESKTOP.jpg" className="aspect-video absolute object-cover w-full h-full" />
